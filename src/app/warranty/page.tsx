      ...
      <div className="container mx-auto px-4 md:px-6 py-8">
        <div className="max-w-3xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 md:p-8">
          <div className="prose max-w-none dark:prose-invert">
            ...
            <h3 className="text-xl font-medium text-gray-800 dark:text-white mt-6 mb-3">Damaged or Defective Products</h3>
            ...
            <p className="mb-4 text-gray-700 dark:text-gray-300">
              If you have any questions about our warranty or return policy, please contact our customer service team at <a href="mailto:info.nutridry@gmail.com" className="text-amber-600 hover:text-amber-800 dark:text-amber-500 dark:hover:text-amber-400">info.nutridry@gmail.com</a> or call us at +91 9984001117.
            </p>
          </div>
        </div>
      </div>
