    ...
    try {
      ...
      await prisma.product.update({
        ...
        data: {
          ...
          image: imageValue,
          secondaryImage: productDetails.secondaryImage || '',
    ...
    try {
      ...
      await prisma.product.update({
        ...
        data: {
          ...
          ...(productDetails.secondaryImage !== undefined && { secondaryImage: productDetails.secondaryImage || '' }),
          ...(productDetails.images !== undefined && { images: productDetails.images || [] }),
          ...(productDetails.category && { category: productDetails.category }),
          // Make sure other fields are properly typed according to your Prisma schema
